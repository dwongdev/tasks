OC.L10N.register(
    ...
    "Sort by start date, priority and summary." : "Sorter efter start dato, prioritet og oversigt.",
    "Due date" : "Forfaldsdato",
    "Sort by due date, priority and summary." : "Sorter efter afleverings dato, prioritet og oversigt.",
    "Created date" : "Oprettelsesdato",
    "Sort by created date, priority and summary." : "Sorter efter oprettet dato, prioritet og oversigt.",
    "Last modified" : "Sidst ændret",
    "Sort by last-modified date, priority and summary." : "Sorter efter sidste ændringsdato, prioritet og oversigt.",
    "Completed date" : "Fuldført dato",
    "Sort by completed date, priority and summary." : "Sorter efter afsluttet dato, prioritet og oversigt.",
    "Priority" : "Prioritet",
    ...
    "Tags" : "Tags",
    "Sort by tags." : "Sorter efter tags.",
    "Manually" : "Manuelt",
    ...
    "Tomorrow" : "I morgen",
    "An error occurred, unable to create the list." : "Der opstod en fejl, og listen kunne ikke oprettes.",
    ...
    "Show in Deck" : "Vis i Opslag",
    "Edit summary" : "Redigér oversigt",
    "Details" : "Detaljer",
    ...
    "November" : "November",
    "December" : "December",
    "on day {days}" : "på dagen {days}",
    "_{count} time_::_{count} times_" : ["{count} gang","{count} gange"],
