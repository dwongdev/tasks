OC.L10N.register(
    ...
    "Go back" : "Geri dön",
    "Do you want to keep related reminders?" : "İlişkili anımsatıcıları tutmak istiyor musunuz?",
    "Discard reminders" : "Anımsatıcıları kaldır",
    "Keep reminders" : "Anımsatıcıları tut",
    ...
    "Every {interval} {frequency}" : "Her {interval} {frequency}",
    "on {days}" : "{days} günlerinde",
    "until {date}" : "{date} tarihine kadar",
    "{count} times" : "{count} kez",
    "Monday" : "Pazartesi",
    "Tuesday" : "Salı",
    "Wednesday" : "Çarşamba",
    "Thursday" : "Perşembe",
    ...
    "No tag available. Create one!" : "Kullanılabilecek bir etiket yok. İsterseniz oluşturun!",
    "{numberOfTasks} tasks have been added to \"{calendar}\"" : "{numberOfTasks} görev \"{calendar}\" takvimine eklendi",
    "Create new tasks" : "Yeni görevler oluştur",
    "Create {numberOfTasks} tasks from pasted text" : "Yapıştırılan yazıdan {numberOfTasks} görev oluştur",
    "Create tasks" : "Görevler oluştur",
    ...
    "Task is recurring" : "Görev yineleniyor",
    ...
    "[Created yesterday at] LT" : "[Oluşturulma dün şu saatte] LT",
    "[Created today at] LT" : "[Oluşturulma bugün şu saatte] LT",
    "[Created] L" : "[Oluşturulma] L",
    "[Created last] dddd [at] LT" : "[Oluşturulma son] dddd LT [zamanında]",
    "[Created] dddd [at] LT" : "[Oluşturulma] dddd LT [zamanında]",
    ...
    "Select a classification" : "Bir sınıflama seçin",
    ...
    "November" : "Kasım",
    "December" : "Aralık",
    "on day {days}" : "{days} gününde",
    "on the {ordinal} {dayNames}" : "{ordinal} {dayNames} günlerinde",
    "in {months}" : "{months} ayı içinde",
    "_{count} time_::_{count} times_" : ["{count} kez","{count} kez"],
    "Completion date must be in the past." : "Tamamlanma tarihi geçmişte olmalıdır.",
    "Successfully created the task." : "Görev oluşturuldu.",
    "Successfully duplicated the task." : "Görev çoğaltıldı.",
    "Could not duplicate the task." : "Görev çoğaltılamadı.",
    ...
    "Error processing recurring task" : "Yinelenen görev işlenirken sorun çıktı",
    "Task successfully moved to new calendar." : "Görev yeni takvime taşındı.",
    "An error occurred" : "Bir sorun çıktı",
    "Create a task" : "Bir görev oluştur",
